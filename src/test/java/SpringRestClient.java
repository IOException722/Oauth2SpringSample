...
import model.AuthTokenInfo;
import model.User;

 
public class SpringRestClient {
 
    public static final String REST_SERVICE_URI = "http://localhost:8080/FirstVaultCS_M1";
    
    public static final String AUTH_SERVER_URI = "http://localhost:8080/FirstVaultCS_M1/oauth/token";
    ...
    private static void createUser(AuthTokenInfo tokenInfo) {
        ...
        RestTemplate restTemplate = new RestTemplate();
        User user = new User(0,"Sarah","sarah@gmail.com","passsword");
    ...
    private static void updateUser(AuthTokenInfo tokenInfo) {
        ...
        RestTemplate restTemplate = new RestTemplate();
        User user  = new User(1,"Tomy","tomy@gail.com", "password");
        HttpEntity<Object> request = new HttpEntity<Object>(user, getHeaders());
        ResponseEntity<User> response = restTemplate.exchange(REST_SERVICE_URI+"/user/1"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token(),
